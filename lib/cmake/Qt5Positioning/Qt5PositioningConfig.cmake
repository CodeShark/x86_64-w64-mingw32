...
get_filename_component(_realOrig "/lib/cmake/Qt5Positioning" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Positioning_install_prefix "/lib/../" ABSOLUTE)
else()
...
set(Qt5Positioning_VERSION_STRING 5.2.1)
    ...
    foreach(_module_dep ${_Qt5Positioning_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.2.1 ${_Qt5Positioning_FIND_VERSION_EXACT}

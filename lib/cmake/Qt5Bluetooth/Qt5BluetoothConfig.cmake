...
get_filename_component(_realOrig "/lib/cmake/Qt5Bluetooth" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Bluetooth_install_prefix "/lib/../" ABSOLUTE)
else()
...
set(Qt5Bluetooth_VERSION_STRING 5.2.1)
    ...
    foreach(_module_dep ${_Qt5Bluetooth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.2.1 ${_Qt5Bluetooth_FIND_VERSION_EXACT}
